...
/// AppTheme provides Material 3 light and dark themes for the app
class AppTheme {
  ...
  static ThemeData get lightTheme {
    return ThemeData(
      ...
      colorScheme: const ColorScheme.light(
        ...
        error: _errorLight,
        onError: Colors.white, // Text color on error buttons
      ),
      ...
      appBarTheme: const AppBarTheme(
        centerTitle: false,
        elevation: 0,
        scrolledUnderElevation: 2, // Material 3 elevation behavior
